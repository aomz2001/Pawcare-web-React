import { ConditionCardDetail, ConditionCardDetailGroup } from "./ConditionDetails"

const conditionList: ConditionCardDetailGroup[] = [
  {
    id: 1,
    title: '1. ทั่วไป',
    subtitle:
  ...
  {
    id: 3,
    title: '3. การยกเลิกออเดอร์ และการขอคืนเงิน',
    subtitle:
      <>
  ...
  {
    id: 5,
    title: '5. การระงับข้อพิพาทระหว่างผู้ใช้บริการและผู้ให้บริการ (พี่เลี้ยง)',
    subtitle:
      <>
  ...
  {
    id: 6,
    title: '6. ข้อสงวนสิทธิ์ของแพลตฟอร์ม',
    subtitle:
      <>
  ...
  {
    id: 7,
    title: '7. การรีวิวและคะแนนการประเมินผลงาน',
    subtitle:
      <>
      ...
      <div className="">
        ...
        <div className="container">
          <div className="p-14">
            ...
            {conditionList.map(item => <ConditionCardDetail key={item.id} detail={item} />)}
          </div>
        </div>
      </div>
    </>
