...
const Footer = () => {
  return (
    <>
      <footer className="bg-[#584E4E] ">
        <div className="mx-auto w-full max-w-screen-xl text-lg">
          <div className="flex gap-8 px-4 py-6 lg:py-8 md:flex-cols-2 justify-around ">
            <div>
        ...
        <div className=" px-4 py-6 bg-[#2D2D2D]  ">
          <div className="container md:flex md:items-center md:justify-between">
            <div className="flex mt-4 md:items-center justify-center space-x-5 rtl:space-x-reverse">
